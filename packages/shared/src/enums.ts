// Central enums used across server (DB CHECK constraints + validation) and client.
...
// Statuses that actively hold a seat (used by the partial-unique integrity index).
