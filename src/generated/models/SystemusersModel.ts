...
export interface SystemusersBase {
  ...
  "in_apiinfoid@odata.bind"?: string;
  in_deviceid?: string;
  in_internalphone?: string;
  in_isintegrationuser?: boolean;
  in_refresh_token?: string;
  in_t1?: string;
  in_t2?: string;
...
export interface Systemusers extends SystemusersBase {
  ...
  fullname?: string;
  identityid: number;
  in_apiinfoidname?: string;
  in_isintegrationusername?: string;
